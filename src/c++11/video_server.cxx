        ...
        unsigned int& samples_read)
{
    ...
    for (auto sample : samples) {
        if (sample.info().valid()) {
            std::cout << "Read a video control sample (\""
                      << sample.data().color()
        ...
        unsigned int sample_count)
{
    ...
    dds::topic::Topic<::ShapeTypeExtended> topic(participant, "video_control");
    ...
    dds::sub::DataReader<::ShapeTypeExtended> reader(
            subscriber,
            topic,
            qos_provider.datareader_qos("tsn_library::video_profile"));
    ...
    std::cout << "::Video control server waiting for connection" << std::endl;
